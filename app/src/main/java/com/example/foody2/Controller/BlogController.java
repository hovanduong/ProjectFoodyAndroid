...
import com.example.foody2.Adapter.AdapterBlog;
...
public class BlogController {
    Context context;
    AdapterBlog apdaterRecyclerBlog;
    ...
    public void getDanhSachQuanAnControllerBlog(final NestedScrollView nestedScrollView, final RecyclerView recyclerOdau, final ProgressBar progressBar, final Location vitrihientai, final SwipeRefreshLayout swiperefresh) {
        final List<QuanAnModel> quanAnModelList = new ArrayList<>();
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(context);
        recyclerOdau.setLayoutManager(layoutManager);
        apdaterRecyclerBlog = new AdapterBlog(context, quanAnModelList, R.layout.custom_layout_recylerview_blog);
        recyclerOdau.setAdapter(apdaterRecyclerBlog);
                    ...
                    storageHinhAnh.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                        ...
                        public void onSuccess(byte[] bytes) {
                            ...
                            if (quanAnModel.getBitmapList().size() == quanAnModel.getHinhanhquanan().size()) {
                                ...
                                apdaterRecyclerBlog.notifyDataSetChanged();
        ...
        swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getDanhSachQuanAnControllerBlog(nestedScrollView, recyclerOdau, progressBar, vitrihientai, swiperefresh);
            }
        });
