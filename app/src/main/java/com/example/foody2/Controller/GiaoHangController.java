...
public class GiaoHangController {
    ...
    public GiaoHangController(Context context) {
    ...
    public void getDanhSachQuanAnGiaoHangController(final NestedScrollView nestedScrollView, final RecyclerView recyclerOdau, final ProgressBar progressBar, final Location vitrihientai, final SwipeRefreshLayout swiperefresh) {
        final List<QuanAnModel> quanAnModelList = new ArrayList<>();
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(context);
        recyclerOdau.setLayoutManager(layoutManager);
        adapterGiaoHang = new AdapterGiaoHang(context, quanAnModelList, R.layout.cus_layout_recyclerview_odau);
        recyclerOdau.setAdapter(adapterGiaoHang);
        ...
        swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getDanhSachQuanAnGiaoHangController(nestedScrollView, recyclerOdau, progressBar, vitrihientai, swiperefresh);
            }
        });
