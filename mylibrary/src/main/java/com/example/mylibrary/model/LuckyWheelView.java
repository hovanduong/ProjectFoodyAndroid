...
public class LuckyWheelView extends RelativeLayout implements com.example.mylibrary.model.PielView.PieRotateListener {
    ...
    private com.example.mylibrary.model.PielView pielView;
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mTopTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextSize, (int) com.example.mylibrary.model.LuckyWheelUtils.convertDpToPixel(10f, getContext()));
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) com.example.mylibrary.model.LuckyWheelUtils.convertDpToPixel(20f, getContext()));
            mTextColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwTopTextColor, 0);
            mTopTextPadding = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextPadding, (int) com.example.mylibrary.model.LuckyWheelUtils.convertDpToPixel(10f, getContext())) + (int) com.example.mylibrary.model.LuckyWheelUtils.convertDpToPixel(10f, getContext());
    ...
    private boolean isPielView(View view) {
        ...
        return view instanceof com.example.mylibrary.model.PielView;
    }
